    ...
    return (
        <div className='hero-container'>
            <div className="home-head">
                <h1 className="home-title">Redefining Financial <br /> Freedom</h1>
                <p className="home-desc">
                    Revolutionizing finance with technology,
                    enabling seamless transactions, smarter <br />
            ...
            <div className="home-contentbox">
                ...
                <div className="contentbox-intro">
                    ...
                    <div className="contentbox-intro-short">Salary advance <br /> credit</div>
                    ...
                    <div className="contentbox-intro-desc">
                        “launching MDPD to power up salary advances through our robust credit services”
                    </div>
                </div>
                ...
                <div className="contentbox-intro">
                    ...
                    <div className="contentbox-intro-short">Real-time <br />Student Credit</div>
                    <div className="contentbox-intro-download">
                        <Button
                            key={`mdpa-download-app`}
                            id='mdpa-download-app'
                    ...
                    <div className="contentbox-intro-points">
                        ...
                        <div className="contentbox-intro-point">
                            <div className="value-main">
                                ...
                                <div className="icon" dangerouslySetInnerHTML={{ __html: Icons.star }}></div>
                            </div>
