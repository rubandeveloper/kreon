...
const DetailsSection = () => {
  const [DetailsContent, setDetailsContent] = useState({
    ...
    title: `Kreon Finnancial's Guiding <br /> Principles and Core Values`,
    items: [
      {
  ...
  return (
    <div
      className="tablesection-container-main"
      style={{
    ...
    >
      <div className="tablesection-container-content">
        <div className="tablesection-head">
          ...
          <h1
            className="tablesection-title"
            dangerouslySetInnerHTML={{ __html: DetailsContent.title }}
          ></h1>
        </div>
