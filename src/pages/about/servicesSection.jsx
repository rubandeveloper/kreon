    ...
    const [Services, setServices] = useState([
        {
            ...
            buttons: [
                { label: 'DOWNLOAD APP', icon: Icons.playstore, iconAlign: 'right', callback: () => { }, customStyle: { width: '100%' } },
                { label: 'VISIT SITE', icon: Icons.link, iconAlign: 'right', callback: () => { }, type: 'secondary', customStyle: { width: '100%' } }
            ],
        },
        {
        ...
        },
        {
            ...
            buttons: [
                { label: 'GET MY LOAN', icon: Icons.playstore, iconAlign: 'right', callback: () => { }, customStyle: { width: '100%' } },
            ],
        },
    ])
                                ...
                                <div className="item-rating-items">
                                    {service.ratings.map((rating, index) => (
                                        <div className="item-rating-item">
                                            ...
                                            {rating.icon && <div className="icon" dangerouslySetInnerHTML={{ __html: rating.icon }}></div>}
                                        </div>
                                    ))}
                                </div>
