    ...
    >
      <div className="footer-content">
        <div className="footer-content-details">
          ...
          <div className="details-desc">
            Kreon Finnancial drives financial inclusion through innovative,
            tech-enabled solutions, fostering trust, accessibility, and growth
        ...
        <div className="footer-content-contact">
          ...
          <div className="contact-items">
            <div className="contact-item">
              Call: <a href="#">+91 8062406300</a>
            </div>
            <div className="contact-item">
              E-Mail: <a href="mailto:info@kreon.in">info@kreon.in</a>
            </div>
          </div>
        </div>
          ...
          <div className="connect-items">
            {Connects.map((item, index) => (
              <a
                ...
                href={ReverseProxy["proxyUrl"] + item.url}
              >
                <img className="connect-item" src={item.img} alt="" />
              </a>
            ))}
          </div>
        </div>
      ...
      <div className="footer-content-bottom">
        ...
        <div className="bottom-copyright">
          © Kreon FinNancial All rights reserved
        </div>
        ...
        <Link
          to={DeveloperData.url}
          target={"_blank"}
          className="bottom-developer"
        >
          Designed and Developed by {DeveloperData.name}
        </Link>
      </div>
    </div>
  );
